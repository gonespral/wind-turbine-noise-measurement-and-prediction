...
subroutine OASPL(n,ox,oy,oz,windvel,rpm,B,Hub,rad,c,c1,alpha,nu,c0,psi,AR,SPLoa,f,SPLf)
  implicit none
  integer, parameter :: dp = kind(0.d0)
  ! in
  ...
  real(dp), dimension(27) :: TE,TV,BLVS,BVS,AdB
  real(dp), dimension(27), intent(out) :: f, SPLf
  ...
  !f = (/800.0_dp,1000.0_dp,1250.0_dp,1600.0_dp,2000.0_dp,2500.0_dp,3150.0_dp/)
...
subroutine turbinepos(nturb,nseg,nobs,x,y,obs,winddir,windvel,rpm,B,Hub,&
  rad,c,c1,alpha,nu,c0,psi,AR,noise_corr,SPL_obs,f,SPLf)
  implicit none
  integer, parameter :: dp = kind(0.d0)
  ! in
  ...
  do i = 1,nturb ! for each turbine
    ...
    call OASPL(nseg,ox,oy,oz,windvel(i),rpm(i),B,Hub,rad,c,c1,alpha,nu,c0,psi,AR,tSPL(i),f,SPLf)
  end do
